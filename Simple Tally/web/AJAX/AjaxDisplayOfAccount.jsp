...
<%
  ...
  <div id="cndnt">
      <%
         String sel="select * from tbl_doac where grp='"+auth+"' and max(id)";
     ...
     if(auth.equals("Pre Defined Display Of Accont in Tally"))
     {
         %>
         <div id="cndnt">
     ...
     <div id="cndnt">
      <%
         String sel1="select * from tbl_doac where grp='"+auth+"' order by id desc limit 1";
  ...
  <div id="cndnt2">
      <%
         String sel12="select * from tbl_doac where grp='"+auth+"' order by id desc limit 1";
