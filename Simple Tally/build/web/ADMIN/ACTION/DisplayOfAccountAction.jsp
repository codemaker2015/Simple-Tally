...
//checking if request cotains multipart data
    ...
    String insert="insert into tbl_doac(grp,txt,vid,img) values('"+grp+"','"+txt1+"','"+filename+"','"+filename2+"')";
 
    if(con.executeCommand(insert))
    {
        response.sendRedirect("../Display Of Account.jsp");
    }
    else
    {
         response.sendRedirect("../Display Of Account.jsp?Error");
    }
    %>