    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu animated-dropdown-menu" role="menu" style="background-color: #ffffcc;">
                  ...
                  <li class="divider"></li>
                  <li><a href="CompanyInfo.jsp" class="text-black">Company Info</a></li>
                  <li class="divider"></li>
                  <li><a href="AccWithInvntry.jsp" class="text-black">Account with Inventory</a></li>
                  <li class="divider"></li>
                  <li><a href="DisplayOfAccount.jsp" class="text-black">Display of Accounts</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu animated-dropdown-menu" style="background-color: #ffffcc; " role="menu">
                  ...
                  <li class="divider"></li>
                  <li><a href="TaxationWrk.jsp" class="text-black">Taxation Work in Tally</a></li>
              <%--  <li><a href="#">Something else here</a></li>
                <li class="divider"></li>
                <li><a href="#">Separated link</a></li>
                <li class="divider"></li>
            ...
            <li >
                <a href="ShortCut.jsp" >Tally Shortcut</a>
              </li>
              <li >
                  <a href="TallyJobs.jsp"  >Tally Jobs</a>
            </li>
            <li >
     ...
     <%--       <li class="dropdown user user-menu pull-righ">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" >
                ...
                <span class="hidden-xs">Basil Joy</span>
              </a>
              <ul class="dropdown-menu">
